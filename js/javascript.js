...
/* 'fade1' gets called in if the 'img1' id element is less than one (invisible). */         
      }
    }
   fade1();
...
/* The browser will collect the answers by looking for the elements with classes 'question1' and 'question2' when the submit button is pressed. */
